...
clubess = '🇪🇪 Grêmio 🇪🇪'
        ...
        //fake reply
            ...
            let fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "*⚡ɴᴇʏᴍᴀʀ ʙᴏᴛ ⚡*", 'jpegThumbnail': thumbnail}}}
...
imageMsg = (await cofs.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              ...
              prep = await cofs.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
              cofs.relayWAMessage(prep)
      break
      case 'menu2':
      const menus = ["neymar1","neymar2","neymar3","neymar4","neymar5"]
men = menus[Math.floor(Math.random() * menus.length)]
menu = fs.readFileSync('./menu/'+men+'.mp4')
                    cofs.sendMessage(from, menu, MessageType.video, {quoted: fgif, mimetype: 'video/gif', ptt:true, quoted: fgif, thumbnail: fs.readFileSync('./configuracoes/perfil22.jpg'), sendEphemeral: true, caption: help(clubess, pushname, tipo, role, prefix) })
                    break
case 'corinthians':
